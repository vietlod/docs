...
**Do not use ARDL** when any variable is I(2), or when the data is multi-unit panel data (consider [FEM/REM](/en/ecolab/mo-hinh/fem-rem) or panel ARDL/PMG).
...
- [FEM and REM for panel data](/en/ecolab/mo-hinh/fem-rem)
