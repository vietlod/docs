...
:::tip Sharp vs Fuzzy
**Sharp RDD**: crossing the cutoff ⇒ surely treated. **Fuzzy RDD**: crossing only **increases the probability** of treatment ⇒ combine with [IV](/en/ecolab/mo-hinh/iv-2sls) (using the cutoff as instrument).
:::
...
- [DiD](/en/ecolab/mo-hinh/did) · [PSM](/en/ecolab/mo-hinh/psm) · [IV/2SLS](/en/ecolab/mo-hinh/iv-2sls) · [Catalog](/en/ecolab/mo-hinh/danh-muc)
