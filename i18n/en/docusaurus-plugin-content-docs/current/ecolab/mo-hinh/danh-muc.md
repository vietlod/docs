...
| 3 | **Linear panel data** | Pooled OLS, [Fixed Effects](/en/ecolab/mo-hinh/fem-rem), [Random Effects](/en/ecolab/mo-hinh/fem-rem), Between | Many units × many periods |
| 4 | **Dynamic panel data** | [Arellano-Bond (Diff GMM)](/en/ecolab/mo-hinh/gmm), [Blundell-Bond (System GMM)](/en/ecolab/mo-hinh/gmm) | Lagged variable, endogeneity, large N small T |
...
| 9 | **Multivariate time series** | [VAR](/en/ecolab/mo-hinh/vecm), [VECM](/en/ecolab/mo-hinh/vecm), SVAR | Multi-variable systems, cointegration |
...
| 12 | **Causal inference** | [DiD](/en/ecolab/mo-hinh/did), PSM, RDD | Policy impact evaluation |

> In addition, [ARDL](/en/ecolab/mo-hinh/ardl) (Autoregressive Distributed Lag) supports long-run/short-run relationships for time series with mixed I(0)/I(1) integration orders.
...
- Family detail pages: [Panel data (FEM/REM)](/en/ecolab/mo-hinh/fem-rem) · [Dynamic panel (GMM)](/en/ecolab/mo-hinh/gmm) · [ARDL](/en/ecolab/mo-hinh/ardl) · [VECM](/en/ecolab/mo-hinh/vecm) · [DiD](/en/ecolab/mo-hinh/did)
