---
title: 'Example: FDI and economic growth in Vietnam (ARDL)'
sidebar_position: 1
...
> Summary: with a national time series for 1990–2023 and variables of mixed I(0)/I(1) order of integration, the [ARDL model](/en/ecolab/mo-hinh/ardl) is a suitable choice to estimate both the long-run and short-run relationships between FDI and growth.
...
- [ARDL Model](/en/ecolab/mo-hinh/ardl) — details of the assumptions and the bounds test
- [FEM and REM](/en/ecolab/mo-hinh/fem-rem) — if extending to multi-province/multi-country panel data
