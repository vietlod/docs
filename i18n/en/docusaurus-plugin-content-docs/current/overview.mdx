...
This documentation replaces the previous source-by-source guide with articles organized around in-app workflows. New users should start with [Login -> Filter/Select -> Preview -> Export](/bat-dau/login-filter-preview-export), then read the detailed indicator guides for each data group.
