---
id: wto-overview
title: Tổng quan Thống kê Thương mại WTO
sidebar_label: Tổng quan Thống
sidebar_position: 1
description: Tổng quan Thống kê Thương mại WTO - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - wto
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/wto/wto-overview.mdx
---

# Tổng quan Thống kê Thương mại WTO

## Giới thiệu

Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu wto phục vụ nghiên cứu kinh tế lượng.
