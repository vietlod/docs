...
title: Wb Doing Business
sidebar_label: Wb Doing Business
sidebar_position: 1
description: Wb Doing Business - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - world-bank
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/world-bank/wb-doing-business.mdx
---
...
Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu world-bank phục vụ nghiên cứu kinh tế lượng.
