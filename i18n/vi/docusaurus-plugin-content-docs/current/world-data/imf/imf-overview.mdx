---
id: imf-overview
title: Tổng quan dữ liệu IMF
sidebar_label: Tổng quan dữ
sidebar_position: 1
description: Tổng quan dữ liệu IMF - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - imf
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/imf/imf-overview.mdx
---

# Tổng quan dữ liệu IMF
