---
id: fred-overview
title: Fred Tổng quan
sidebar_label: Fred Tổng quan
sidebar_position: 1
description: Fred Tổng quan - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - other-sources
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/other-sources/fred-overview.mdx
---
