...
sidebar_label: Oecd National Accounts
sidebar_position: 1
description: Oecd National Accounts - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - oecd
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/oecd/oecd-national-accounts.mdx
---
...
Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu oecd phục vụ nghiên cứu kinh tế lượng.
