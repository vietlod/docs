---
id: oecd-overview
title: Tổng quan dữ liệu OECD
sidebar_label: Tổng quan dữ
sidebar_position: 1
description: Tổng quan dữ liệu OECD - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - oecd
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/oecd/oecd-overview.mdx
---

# Tổng quan dữ liệu OECD
