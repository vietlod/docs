---
id: ilo-overview
title: Tổng quan Thống kê Lao động ILO
sidebar_label: Tổng quan Thống
sidebar_position: 1
description: Tổng quan Thống kê Lao động ILO - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - ilo
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/ilo/ilo-overview.mdx
---

# Tổng quan Thống kê Lao động ILO

## Giới thiệu

Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu ilo phục vụ nghiên cứu kinh tế lượng.
