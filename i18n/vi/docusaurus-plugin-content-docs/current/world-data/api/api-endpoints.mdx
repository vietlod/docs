---
id: api-endpoints
title: Tham khảo Điểm cuối API
sidebar_label: Tham khảo Điểm
sidebar_position: 1
description: Tham khảo Điểm cuối API - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - api
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/api/api-endpoints.mdx
---

# Tham khảo Điểm cuối API

## Giới thiệu

Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu api phục vụ nghiên cứu kinh tế lượng.
