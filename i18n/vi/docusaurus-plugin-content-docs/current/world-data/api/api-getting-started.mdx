...
title: Hướng dẫn Bắt đầu API
sidebar_label: Hướng dẫn Bắt
sidebar_position: 1
description: Hướng dẫn Bắt đầu API - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - api
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/api/api-getting-started.mdx
---

# Hướng dẫn Bắt đầu API
