---
id: un-overview
title: Tổng quan dữ liệu Liên Hợp Quốc
sidebar_label: Tổng quan dữ
sidebar_position: 1
description: Tổng quan dữ liệu Liên Hợp Quốc - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - united-nations
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /world-data/united-nations/un-overview.mdx
---

# Tổng quan dữ liệu Liên Hợp Quốc

## Giới thiệu

Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu united-nations phục vụ nghiên cứu kinh tế lượng.
