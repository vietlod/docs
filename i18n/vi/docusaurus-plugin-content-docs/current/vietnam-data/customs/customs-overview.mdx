---
id: customs-overview
title: Tổng quan Dữ liệu Hải quan
sidebar_label: Tổng quan Dữ
sidebar_position: 1
description: Tổng quan Dữ liệu Hải quan - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - customs
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/customs/customs-overview.mdx
---

# Tổng quan Dữ liệu Hải quan
