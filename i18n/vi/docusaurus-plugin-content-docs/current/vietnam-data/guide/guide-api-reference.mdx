...
title: Tham khảo API Dữ liệu Việt Nam
sidebar_label: Tham khảo API
sidebar_position: 1
description: Tham khảo API Dữ liệu Việt Nam - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - guide
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/guide/guide-api-reference.mdx
---

# Tham khảo API Dữ liệu Việt Nam
