...
title: Xuất Dữ liệu Việt Nam
sidebar_label: Xuất Dữ liệu
sidebar_position: 1
description: Xuất Dữ liệu Việt Nam - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - guide
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/guide/guide-export-data.mdx
---

# Xuất Dữ liệu Việt Nam
