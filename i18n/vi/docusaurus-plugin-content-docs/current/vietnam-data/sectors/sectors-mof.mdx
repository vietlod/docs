---
id: sectors-mof
title: Dữ liệu Tài chính Chính phủ
sidebar_label: Dữ liệu Tài
sidebar_position: 1
description: Dữ liệu Tài chính Chính phủ - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - sectors
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/sectors/sectors-mof.mdx
---

# Dữ liệu Tài chính Chính phủ

## Giới thiệu

Tài liệu này cung cấp hướng dẫn chi tiết về dữ liệu sectors phục vụ nghiên cứu kinh tế lượng.
