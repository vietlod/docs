---
id: sectors-evn
title: Dữ liệu Điện lực
sidebar_label: Dữ liệu Điện
sidebar_position: 1
description: Dữ liệu Điện lực - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - sectors
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/sectors/sectors-evn.mdx
---
