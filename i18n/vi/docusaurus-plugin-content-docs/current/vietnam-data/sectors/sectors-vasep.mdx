---
id: sectors-vasep
title: Dữ liệu Thủy sản
sidebar_label: Dữ liệu Thủy
sidebar_position: 1
description: Dữ liệu Thủy sản - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - sectors
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/sectors/sectors-vasep.mdx
---
