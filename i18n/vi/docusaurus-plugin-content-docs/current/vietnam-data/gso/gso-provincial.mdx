---
id: gso-provincial
title: Dữ liệu Cấp Tỉnh
sidebar_label: Dữ liệu Cấp
sidebar_position: 1
description: Dữ liệu Cấp Tỉnh - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - gso
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/gso/gso-provincial.mdx
---
