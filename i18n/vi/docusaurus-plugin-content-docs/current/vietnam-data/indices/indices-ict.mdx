---
id: indices-ict
title: Chỉ số Phát triển ICT
sidebar_label: Chỉ số Phát
sidebar_position: 1
description: Chỉ số Phát triển ICT - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - indices
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/indices/indices-ict.mdx
---
