...
sidebar_label: Chỉ số Năng
sidebar_position: 1
description: Chỉ số Năng lực Cạnh tranh Cấp tỉnh - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - indices
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/indices/indices-pci.mdx
---
