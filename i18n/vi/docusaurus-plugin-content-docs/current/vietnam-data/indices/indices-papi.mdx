---
id: indices-papi
title: Chỉ số Quản trị Công Cấp tỉnh
sidebar_label: Chỉ số Quản
sidebar_position: 1
description: Chỉ số Quản trị Công Cấp tỉnh - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - indices
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/indices/indices-papi.mdx
---

# Chỉ số Quản trị Công Cấp tỉnh
