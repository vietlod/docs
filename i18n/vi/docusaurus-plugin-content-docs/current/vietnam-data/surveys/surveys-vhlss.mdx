---
id: surveys-vhlss
title: Khảo sát Mức sống Hộ gia đình
sidebar_label: Khảo sát Mức
sidebar_position: 1
description: Khảo sát Mức sống Hộ gia đình - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - surveys
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/surveys/surveys-vhlss.mdx
---
