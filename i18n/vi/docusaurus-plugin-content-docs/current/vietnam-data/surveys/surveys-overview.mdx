---
id: surveys-overview
title: Tổng quan Dữ liệu Khảo sát
sidebar_label: Tổng quan Dữ
sidebar_position: 1
description: Tổng quan Dữ liệu Khảo sát - Dữ liệu kinh tế cho nghiên cứu kinh tế lượng.
keywords:
  - surveys
  - dữ liệu kinh tế
  - nghiên cứu kinh tế lượng
slug: /vietnam-data/surveys/surveys-overview.mdx
---
