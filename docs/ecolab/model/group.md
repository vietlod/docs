...
| 3 | **Dữ liệu bảng tuyến tính** | Pooled OLS, [Fixed Effects](/ecolab/model/fem-rem), [Random Effects](/ecolab/model/fem-rem), Between | Nhiều đơn vị × nhiều kỳ |
| 4 | **Dữ liệu bảng động** | [Arellano-Bond (Diff GMM)](/ecolab/model/gmm), [Blundell-Bond (System GMM)](/ecolab/model/gmm) | Có biến trễ, nội sinh, N lớn T nhỏ |
...
| 9 | **Chuỗi thời gian đa biến** | [VAR](/ecolab/model/vecm), [VECM](/ecolab/model/vecm), SVAR | Hệ nhiều biến, đồng liên kết |
| 10 | **IV & hệ phương trình** | IV/2SLS, 3SLS, SUR | Nội sinh, hệ phương trình |
| 11 | **Phi tuyến & bán tham số** | NLS, GAM | Quan hệ phi tuyến |
| 12 | **Suy luận nhân quả** | [DiD](/ecolab/model/did), PSM, RDD | Đánh giá tác động chính sách |

> Ngoài ra, [ARDL](/ecolab/model/ardl) (Autoregressive Distributed Lag) hỗ trợ quan hệ dài hạn/ngắn hạn cho chuỗi thời gian có bậc tích hợp hỗn hợp I(0)/I(1).
...
- Trang chi tiết theo họ: [Dữ liệu bảng (FEM/REM)](/ecolab/model/fem-rem) · [Bảng động (GMM)](/ecolab/model/gmm) · [ARDL](/ecolab/model/ardl) · [VECM](/ecolab/model/vecm) · [DiD](/ecolab/model/did)
