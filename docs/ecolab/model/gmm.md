...
Trong EcoLab, GMM thuộc nhóm **Dữ liệu bảng** và sinh mã tái lập Stata/R/Python. Xem [FEM và REM](/ecolab/model/fem-rem) và [Ước lượng & Mô hình hóa](/ecolab/econometrics-modeling).
