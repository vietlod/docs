---
title: 'Ví dụ: Lợi suất giáo dục lên tiền lương (OLS)'
sidebar_position: 3
...
# Ví dụ: Lợi suất giáo dục lên tiền lương (hàm Mincer, OLS)

Minh họa quy trình 5 bước của EcoLab với mô hình kinh điển nhất trong kinh tế lao động: **hàm tiền lương Mincer** ước lượng bằng [OLS](/ecolab/mo-hinh/ols). Số liệu kết quả là **minh họa định dạng**.
...
## Xem thêm
- [OLS](/ecolab/mo-hinh/ols) · [Ví dụ IV](/ecolab/vi-du/iv-loi-suat-giao-duc) · [Danh mục](/ecolab/mo-hinh/danh-muc)
