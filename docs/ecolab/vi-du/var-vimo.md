---
title: 'Ví dụ: Lãi suất – lạm phát – sản lượng (VAR)'
sidebar_position: 9
...
# Ví dụ: Tương tác lãi suất – lạm phát – sản lượng (VAR)

Minh họa [VAR](/ecolab/mo-hinh/var): phân tích **động học hệ thống vĩ mô** giữa lãi suất chính sách, lạm phát và sản lượng — không áp đặt chiều nhân quả tiên nghiệm. Số liệu là **minh họa**.
...
## Xem thêm
- [VAR](/ecolab/mo-hinh/var) · [SVAR](/ecolab/mo-hinh/svar) · [VECM](/ecolab/mo-hinh/vecm) · [Danh mục](/ecolab/mo-hinh/danh-muc)
