---
title: 'Ví dụ: FDI và tăng trưởng kinh tế Việt Nam (ARDL)'
sidebar_position: 1
...
# Ví dụ thực nghiệm: FDI và tăng trưởng kinh tế Việt Nam (ARDL)
...
> Tóm tắt: với chuỗi thời gian quốc gia 1990–2023 và các biến có bậc tích hợp hỗn hợp I(0)/I(1), [mô hình ARDL](/ecolab/mo-hinh/ardl) là lựa chọn phù hợp để ước lượng đồng thời quan hệ dài hạn và ngắn hạn giữa FDI và tăng trưởng.
...
- [Mô hình ARDL](/ecolab/mo-hinh/ardl) — chi tiết giả định và kiểm định đường bao
- [FEM và REM](/ecolab/mo-hinh/fem-rem) — nếu mở rộng sang dữ liệu bảng nhiều tỉnh/quốc gia
