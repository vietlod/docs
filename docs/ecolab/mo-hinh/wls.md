...
**WLS (Weighted Least Squares)** là biến thể của [OLS](/ecolab/mo-hinh/ols) dùng khi **phương sai sai số thay đổi (heteroskedasticity)** và ta biết (hoặc ước lượng được) cấu trúc của nó. WLS gán **trọng số** tỉ lệ nghịch với phương sai sai số để khôi phục tính hiệu quả của ước lượng.
...
- Nếu phương sai phải ước lượng từ dữ liệu, ta có [FGLS](/ecolab/mo-hinh/gls) (Feasible GLS).
...
- Khi không chắc cấu trúc phương sai, ưu tiên OLS + robust SE hoặc [GLS/FGLS](/ecolab/mo-hinh/gls).
