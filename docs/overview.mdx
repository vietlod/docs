...
Tài liệu này thay thế cấu trúc hướng dẫn cũ bằng các bài viết theo flow thao tác trong ứng dụng. Người dùng mới nên bắt đầu từ bài [Login → Filter/Select → Preview → Export](/bat-dau/login-filter-preview-export), sau đó đọc chi tiết từng nhóm indicators.
